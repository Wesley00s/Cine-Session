...
class KtorMovieRemoteDatasource @Inject constructor(
    ...
    companion object {
        ...
        suspend fun getDetailsMoviesDataResponse(id: Int): Result<MovieInfo> = try {
            val response = httpClient.httpClientAndroid
        ...
        suspend fun getPopularMovies(page: Int): Result<ListMoviesResponse> = try {
            val response = httpClient.httpClientAndroid
        ...
        suspend fun getTopRatedMovies(page: Int): Result<ListMoviesResponse> = try {
            val response = httpClient.httpClientAndroid
        ...
        suspend fun getTopRatedSeries(page: Int): Result<ListSeriesResponse> = try {
            val response = httpClient.httpClientAndroid
        ...
        suspend fun searchMovies(query: String, page: Int): Result<ListMoviesResponse> = try {
            val response = httpClient.httpClientAndroid
